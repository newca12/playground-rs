...
pub trait TPTPBaseListener<'input>:
    ParseTreeListener<'input, TPTPParserContextType> {

    /**
     * Enter a parse tree produced by \{@link TPTPBaseParser#s}.
     * @param ctx the parse tree
     */
    fn enter_tptp_file(&mut self, _ctx: &Tptp_fileContext<'input>) {}
    /**
     * Exit a parse tree produced by \{@link  TPTPBaseParser#s}.
     * @param ctx the parse tree
     */
